...
class IfcProject:
    ...
    def __init__(self, project_file, project_name, reference_null_point):
    ...
    def _create_unit_assignment(self) -> any:
        self.length_si_unit = self.project_file.createIfcSIUnit(None, "LENGTHUNIT", None, length_unit)
