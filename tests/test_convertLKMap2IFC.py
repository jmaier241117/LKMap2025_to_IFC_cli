...
class TestCLI(unittest.TestCase):
    ...
    def test_import_file_not_available(self):
        with self.runner.isolated_filesystem():
            ...
            self.assertEqual(
                (b'Error: The file abc.xtf cannot be found\r\n'),
                result.stdout_bytes)
            self.assertGreater(result.exit_code, 0)
    ...
    def test_invalid_2d_wkt_point(self):
        ...
        self.assertEqual(
            (b'Error: The WKT Point provided must be 3 Dimensional!\r\n'),
            result.stdout_bytes)
        self.assertGreater(result.exit_code, 0)
    ...
    def test_invalid_wkt_point(self):
        ...
        self.assertEqual(
            (b"Usage: convertlkmap2ifc [OPTIONS] IMPORT_FILE\r\nTry 'convertlkmap2ifc --h"
             b"elp' for help.\r\n\r\nError: Invalid value for '--null_point': '(1 2 3)' is "
             b'not a valid WKT Point\r\n'),
            result.stdout_bytes)
        self.assertGreater(result.exit_code, 0)
